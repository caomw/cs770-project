...
#define LEFT 0
#define RIGHT 1
#define DEFAULT_PORT "5050\0"
#define DEFAULT_IP "127.0.0.1\0"
...
public:
	...
	/// <summary>
	/// Handle windows messages for the network settings instance
	/// </summary>
	/// <param name="hWnd">window message is for</param>
	/// <param name="uMsg">message</param>
	/// <param name="wParam">message data</param>
	/// <param name="lParam">additional message data</param>
	/// <returns>result of message processing</returns>
	static LRESULT CALLBACK NetworkSettings(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
...
private:
	...
	// send data to socket
	void SendHandPositionOrientation(CameraSpacePoint point);
};
