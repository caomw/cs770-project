...
\begin{abstract}
  ...
  Through our exploration and discussion, we show that kinesiological
  control can enable novices to accomplish simple robot arm
  manipulation tasks with greater dexterity.
\end{abstract}
